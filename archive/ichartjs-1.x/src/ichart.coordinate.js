...
iChart.Scale = iChart.extend(iChart.Component, {
    configure: function () {
        ...
        this.set({
            ...
            start_scale: 0,
            /**
             * @cfg {Number} Specifies the label's step on the axis,Setting the step to 2 shows every other label.(default to 1)
             */
            step: 1,
            /**
    ...
    doConfig: function () {
         ...
         */
        if (s_scale > min_s) {
            s_scale = _.push('start_scale', iChart.floor(min_s));
        }
