...
const specs = {
  ...
  delivery: { ...base, type: 'gantt', renderer: 'svg', width: 420, height: 190, padding: { top: 22, right: 10, bottom: 34, left: 24 }, theme: { ...base.theme, typography: { axis: { size: 10, font: '450 10px system-ui, sans-serif' }, legend: { size: 10, font: '550 10px system-ui, sans-serif' } } }, data: [{ id: 'discover', name: 'Discover', start: '2026-09-01', end: '2026-09-05', progress: 1 }, { id: 'build', name: 'Build', start: '2026-09-06', end: '2026-09-15', progress: .72, dependencies: ['discover'] }, { id: 'verify', name: 'Verify', start: '2026-09-16', end: '2026-09-20', progress: .35, dependencies: ['build'] }], title: { text: 'Delivery plan' } },
  architecture: { ...base, type: 'architecture', renderer: 'svg', width: 380, height: 190, padding: { top: 18, right: 12, bottom: 24, left: 12 }, theme: { ...base.theme, typography: { title: { size: 14 }, subtitle: { size: 9 }, axis: { size: 10, font: '450 10px system-ui, sans-serif' }, label: { size: 9 }, legend: { size: 10, font: '550 10px system-ui, sans-serif' } } }, layers: [{ id: 'experience', label: 'Experience' }, { id: 'runtime', label: 'Runtime' }, { id: 'data', label: 'Data' }], nodes: [{ id: 'agent', label: 'Agent', layerId: 'experience' }, { id: 'charts', label: 'iChart.js', layerId: 'runtime' }, { id: 'records', label: 'Records', layerId: 'data' }], edges: [{ id: 'agent-charts', from: 'agent', to: 'charts', relation: 'plans' }, { id: 'records-charts', from: 'records', to: 'charts', relation: 'feeds' }], diagram: { mode: 'architecture', layout: 'layered', routing: 'orthogonal' } }
};
