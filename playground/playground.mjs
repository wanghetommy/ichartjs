export const runtimeVersion = '2.0.0-rc.1';

export function pageNav(active = '') {
  const pages = [
    ['index.html', '首页'], ['project-gallery.html', '完整 Gallery'], ['agent-workbench.html', 'Agent 工作台'], ['project-intelligence.html', '项目分析'], ['editing.html', '业务编辑'], ['diagram-editor.html', 'Diagram'], ['interaction-lab.html', '交互'], ['accessibility-lab.html', '无障碍'], ['performance-lab.html', '性能']
  ];
